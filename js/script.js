...
a = prompt('Enter a numerical value for your trapeze base \'a\'.');
...
h = prompt('Enter a numerical value for your trapeze height \'h\'.');
...
var trapezeArea = (1/2*(Number(a)+Number(b))*(h));
